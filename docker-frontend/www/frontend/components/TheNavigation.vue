<template>
    <nav
        class="d-flex text-bg-success text-uppercase justify-content-center align-items-center p-3"
    >
        <NuxtLink class="text-warning text-decoration-none m-2" to="/"
            >Биржа микрозаданий</NuxtLink
        >
